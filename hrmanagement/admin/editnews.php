...
$conid = $_REQUEST['id'];
 $sqlcon="Select * from tbl_news where news_id = $conid";
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
     <h1><img src="icon_clock.png" width="41" height="41" /> Edit News &amp; Events </h1>
    </div>
      <div class="clear">
    </div>
    <!--  TITLE END  -->    
    ...
    <div class="portlet">
		...
		<input type="hidden" value="<?php echo $conid;?>" name="newsid"/>
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
              ...
              <tr>
			   ...
			   <tr>
				<td><input type="text" class="smallInput wide" name="title" value="<?php echo  $rowcon['news_title']?>" /></td>
              </tr>
            <tr>
				<td><label>Edit Content</label></td>
            </tr>
            <tr>
				<td><textarea id="wysiwyg" class="smallInput wide" rows="7" cols="30" name="desc"><?php echo $rowcon['news_desc']?></textarea></td>
            </tr>
			  <tr>
