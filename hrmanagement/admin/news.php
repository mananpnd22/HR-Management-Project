...
if(isset($_POST['submit']))
{
        ...
        $sqlnews="Insert into  tbl_news (news_title, news_desc, news_date) values ('$title','$desc',now())";
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
     <h1><img src="icon_clock.png" width="45" height="38" /><span class="style3">Add News and Events</span></h1>
    </div>
      <div class="clear">
    </div>
    <!--  TITLE END  -->    
