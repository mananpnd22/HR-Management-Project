...
// Select Employee details here
	...
	$sqlselect_Content = "Select * from tbl_newsletter";
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9"><img src="icon_news.png" width="45" height="38" /><span class="style3"> View Newsletter</span></div>
      <div class="clear">
    </div>
    <!--  TITLE END  -->    
    <!-- #PORTLETS START -->
          ...
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet" align="center">
            ...
            <tbody>
			  ...
			  <tr>
                ...
                <td><?php echo $rescontent['ndesc'];?></td>
                <td><?php echo date('d.m.Y', strtotime($rescontent['ndate']));?></td>
                <td width="90">  <a href="editletter.php?id='<?php echo $rescontent['nletter_id'];?>'" class="edit_icon" title="Edit"></a> <a href="delletter.php?delid='<?php echo $rescontent['nletter_id'];?>'" class="delete_icon" title="Delete"></a></td>
              </tr>
             <?php $chkcnt++; } ?> 
               <tr><td colspan="5" align="right"><a href="sendletter.php">Send newsletter</a></td>
