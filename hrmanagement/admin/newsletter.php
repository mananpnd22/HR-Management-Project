...
if(isset($_POST['submit']))
{
        ...
        $sqlcontent="Insert into  tbl_newsletter (title, ndesc, ndate) values ('$title','$desc',now())";
...
<!-- CONTENT START -->
    ...
    <!--  TITLE START  --> 
    <div class="grid_9">
      <h1><img src="icon_news.png" width="45" height="38" /><span class="style1"> Add Newsletter </span></h1>
    </div>
    <!--  TITLE END  -->
    <!-- #PORTLETS START -->
<div id="portlets">
